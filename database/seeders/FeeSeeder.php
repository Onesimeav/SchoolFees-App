...
class FeeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Installment::create(['tuition_fee_id' => $tuition6->id, 'number' => 1, 'amount' => 200000, 'due_date' => '2024-10-31']);
        Installment::create(['tuition_fee_id' => $tuition6->id, 'number' => 2, 'amount' => 150000, 'due_date' => '2025-01-31']);
        ...
        Installment::create(['tuition_fee_id' => $tuition3->id, 'number' => 1, 'amount' => 210000, 'due_date' => '2024-10-31']);
        Installment::create(['tuition_fee_id' => $tuition3->id, 'number' => 2, 'amount' => 160000, 'due_date' => '2025-01-31']);
        ...
        Installment::create(['tuition_fee_id' => $tuitionTerm->id, 'number' => 1, 'amount' => 250000, 'due_date' => '2024-10-31']);
        Installment::create(['tuition_fee_id' => $tuitionTerm->id, 'number' => 2, 'amount' => 200000, 'due_date' => '2025-01-31']);
        Installment::create(['tuition_fee_id' => $tuitionTerm->id, 'number' => 3, 'amount' => 150000, 'due_date' => '2025-04-30']);
